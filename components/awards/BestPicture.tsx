 ...
 * image, shown as shot on a grey panel), then the title as the one link, and the
 ...
 * underline at rest (a hairline under a step-8 title reads as a rule); a
 * Carolina underline is its hover state and the ring is its focus state.
 */
